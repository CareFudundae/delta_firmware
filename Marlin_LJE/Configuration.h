...
#define CUSTOM_MACHINE_NAME "Levi's Mini Kossel"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 269.55 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 257.825 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 147.73 //mm  Get this value from auto calibrate
