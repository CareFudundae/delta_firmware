...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 266.74//269.51 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 257.56//257.825 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, -0.32, -0.41 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 147.45//147.18 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.38, 0.50, 0.0 } // get these values from auto calibrate
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      {5000,5000,5000,1000} // { 9000, 9000, 9000, 10000 }
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -26//0     // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER -16//-10   // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.3//-3.5  // Z offset: -below +above  [the nozzle]
