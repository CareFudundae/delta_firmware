...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 269.51 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 257.56//257.825 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, -0.29, -0.45 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 147.18 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.37, 0.60, 0.0 } // get these values from auto calibrate
